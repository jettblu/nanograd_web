...
export default function Navbar() {
  return (
    <div className="z-10 w-full items-center justify-between font-mono text-sm lg:flex p-8 mb-6">
      ...
      <div className="invisible md:visible fixed bottom-0 left-0 flex flex-row h-48 w-full items-end justify-center bg-gradient-to-t from-white via-white dark:from-black dark:via-black lg:static lg:h-auto lg:w-auto lg:bg-none">
        <Link
